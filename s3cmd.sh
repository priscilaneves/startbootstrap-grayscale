...
aws s3 cp   dist/*.html s3://xdevel.com.br/*.html  --acl=public-read --delete --cache-control="max-age=86400"
aws s3 cp   dist/*.ico s3://xdevel.com.br/*.ico  --acl=public-read --delete --cache-control="max-age=86400"
