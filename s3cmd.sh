...
aws s3 cp   dist/*.html s3://xdevel.com.br/*.html  --acl=public-read  --cache-control="max-age=86400"
aws s3 cp   dist/*.ico s3://xdevel.com.br/*.ico  --acl=public-read  --cache-control="max-age=86400"
