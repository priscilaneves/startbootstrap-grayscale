...
aws s3 cp   dist/dist/index.html s3://xdevel.com.br/index.html  --acl=public-read  --cache-control="max-age=86400" --content-encoding="gzip"
#not compress
...
aws s3 cp   dist/favicon.ico s3://xdevel.com.br/index.ico  --acl=public-read  --cache-control="max-age=86400"
